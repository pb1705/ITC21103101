...
#d
#shifting a and b both left shifting
print("d) The values of both a and b shifted left bitwise by 2 bits are ",a<<2, "and ",b<<2," respectively" )
#e
#shifting bitwise right a with 2 bits and b with 4 bits
print("e) The value of a shifted right bitwise by 2 bits is ", a>>2, "and The value of b shifted right bitwise by 4 bits is " ,b>>4)
print("\n")
#Question 4
