...
# QUESTION 5
STR_Pattern = input("Enter the string you want to get pattern of") # Getting string to be used in pattern
if len(STR_Pattern) % 2 == 0: # number of iterations in case of even and odd to avoid extra blank line
    number_of_iterations = len(STR_Pattern)//2
else:
    number_of_iterations = (len(STR_Pattern)//2) + 1
for i in range(number_of_iterations):
    print(STR_Pattern)
    k = len(STR_Pattern) -2
    STR_Pattern = " " + STR_Pattern[:k]
